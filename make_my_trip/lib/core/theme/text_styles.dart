...
class AppTextStyles {
  ...
  static const labelDetails = TextStyle(
    height: 1.5,
    fontSize: 16,
  );
  ...
  static const labelDescriptionStyle = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w300,
  );

  static const infoLabelStyle = TextStyle(
    fontSize: 20,
  ...
  static const infoContentStyle6 = TextStyle(
      fontSize: 16, fontWeight: FontWeight.w700, color: Colors.lightBlue);
