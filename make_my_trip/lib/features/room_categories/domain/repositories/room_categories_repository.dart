...
abstract class RoomCategoriesRepository {
  Future<Either<Failures, RoomCategoryModel>> getRoomDetail(int hotelId,String cIn,String cOut);
  Future<Either<Failures , String>> roomBookPost(int hotelId, RoomDataPostModel  roomDataPostModel);
}