                      ...
                      sliver: SliverList(
                        ...
                        [
                              ...
                              (hotelDetailModel?.description == null)
                                  ...
                                  : Align(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          BlocProvider.of<HotelDetailCubit>(
                                                  context)
                          ...
                          ReviewContainer(
                            ...
                            onTap: () {
                              if (hotelDetailModel!.id != null) {
                                Navigator.pushNamed(
                                    context, RoutesName.reviewPage, arguments: {
                          ...
                          ReviewContainer(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  context, RoutesName.galleryPage, arguments: {
                        ...
                        child: CommonPrimaryButton(
                            ...
                            onTap: () {
                              ...
                              var checkOutDate = calenderCubit.outTime
                                  ...
                                  .substring(
                                      0,
                                      calenderCubit.outTime
                                          .toString()
                                          .indexOf(" "));
                              Navigator.pushNamed(
                                  context, RoutesName.roomCategory,
                                  arguments: {
                                    'hotel_id': hotelDetailModel!.id,
                                    "cin": checkInDate,
                                    "cout": checkOutDate,
