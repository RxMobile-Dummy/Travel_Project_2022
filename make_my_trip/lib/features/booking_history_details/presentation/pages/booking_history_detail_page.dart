                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                      flex: 5,
                                      child: Text(
                                        userHistoryModel.first.price.toString(),
                                        style: AppTextStyles.labelStyle
                            ...
                            Padding(
                              ...
                              child: Text(
                                userHistoryModel.first.address!.addressLine
                                    .toString(),
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    subtitle: const Text("18/06/2022",
                                        style:
                                            AppTextStyles.smallBlackTitleStyle),
                                  ),
                                  ListTile(
                                    dense: true,
                                    contentPadding: const EdgeInsets.only(
                                    ...
                                    subtitle: Text(
                                        '${userHistoryModel.first.checkingDate!.substring(0, userHistoryModel.first.checkingDate!.indexOf('T'))} - ${userHistoryModel.first.checkoutDate!.substring(0, userHistoryModel.first.checkoutDate!.indexOf('T'))}',
                                        style:
                                            AppTextStyles.smallBlackTitleStyle),
                                  ),
                                  ListTile(
