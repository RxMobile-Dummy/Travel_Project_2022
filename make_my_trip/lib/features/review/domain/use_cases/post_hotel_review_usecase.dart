...
class PostHotelReviewUseCases implements Usecase<void, PostReviewParams> {
  final ReviewRepository reviewRepository;
  PostHotelReviewUseCases(this.reviewRepository);
  @override
  Future<Either<Failures, void>> call(PostReviewParams postReviewParams) async {
    return await reviewRepository.postHotelReview(postReviewParams.reviewModel,
        postReviewParams.hotelid, postReviewParams.imageFileList);
  }
}
