...
import '../../../../utils/extensions/date_time/date_time_extension.dart';
          ...
          body: BlocBuilder<ReviewCubit, BaseState>(
            builder: (context, state) {
              if (state is StateOnKnownToSuccess) {
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ReviewCardWidget(
                              ...
                              image: reviewModel[index].userId?.userImage ?? "https://www.kindpng.com/picc/m/252-2524695_dummy-profile-image-jpg-hd-png-download.png",
                            );
                          }),
                    ),
                  ],
                ...
                return const Center( child:  const Text("Be the first to review"));
              }
          ...
          floatingActionButton: FloatingActionButton(
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) => PublishReviewPage()));
              },
