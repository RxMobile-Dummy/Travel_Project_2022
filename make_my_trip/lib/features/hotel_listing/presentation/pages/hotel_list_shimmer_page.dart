                    ...
                    itemBuilder: (_, __) => Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ListContainer(hight: size.height * 0.25,width: size.width * 0.9,),

                          Padding(
                              padding: const EdgeInsets.only(top: 10),
                              child: ListContainer(width: size.width * 0.4 ,hight: 25,)
                          ),
                          Row(
                            children: [
                              Padding(
                                  padding: const EdgeInsets.only(top: 10),
                                  child: ListContainer(width: size.width * 0.53 ,hight: 50,)
                              ),
                              const Spacer(),
                              Padding(
                                  padding: const EdgeInsets.only(top: 10,right: 23),
                                  child: ListContainer(width: size.width * 0.25 ,hight: 50,)
                              ),
