...
Future<void> init() async {
  sl.registerFactory(() => HotelCubit(postHotel: sl(),getHotel: sl(),deleteHotel: sl(), getHotelPut: sl(),updateHotel: sl(),addImage: sl(),getHotelImage: sl()));
  // Use cases
  ...
  sl.registerLazySingleton(() => AddHotelImage(repository: sl()));
  sl.registerLazySingleton(() => GetHotelIamges(repository: sl()));
